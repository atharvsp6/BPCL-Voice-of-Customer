...
\hypersetup{
    ...
    urlcolor=cyan,
    citecolor=blue,
    pdftitle={Voice of Customer Analysis - Hello BPCL},
    pdfauthor={},
    bookmarks=true,
    bookmarksopen=true
}
...
\begin{titlepage}
    ...
    {\Huge\bfseries Voice of Customer (VoC) Analysis\\[0.2cm] of Hello BPCL Mobile Application\par}
    ...
    {\Large Data Science \& NLP Internship Project\par}
...
First and foremost, I extend my heartfelt thanks to \textbf{Bharat Petroleum Corporation Limited (BPCL)} for providing me with the opportunity to work on this challenging and insightful project as part of the Data Analytics \& ML Internship .


I am deeply grateful to my project guide, \textbf{Mr. Nilbh Nishchhal  }, for their invaluable guidance, continuous support, and constructive feedback throughout the duration of the project. Their expertise in data science and natural language processing helped shape the direction of this research.



I acknowledge the open-source community for developing and maintaining the excellent libraries and tools used in this project, including NLTK, Gensim, Hugging Face Transformers, PyABSA, Streamlit, and many others.
...
\textbf{Results:} The sentiment classification model achieved \textbf{79.24\% accuracy} with a weighted F1-score of \textbf{0.820}. Four major complaint themes were identified: Login/OTP Issues (24.8\%), Payment Problems (27.4\%), App Updates/Crashes (22.1\%), and Rewards System Complaints (25.7\%). ABSA extracted \textbf{37,124 aspect-sentiment pairs} across \textbf{2,516 unique aspects}. Overall sentiment was positive with 73.1\% positive reviews and a global sentiment score of +0.47.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/rating_distribution.png}
...
\begin{center}
\textit{Report generated as part of the Voice of Customer (VoC) Analysis\\
Internship Project for BPCL.}
\end{center}
